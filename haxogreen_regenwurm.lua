...
function init()
    self.colors = { 0x000000, 0xAA0000,0xAA0000,0xAA0000,0xAA0000,0xAA0000,0xAA0000,0xAA0000,0xAA0000,0xAA0000,0xAA0000,0xAA0000,0xAA0000,0xAA0000,0xAA0000,0xAA0000,0xAA0000,0xAA0000,}
end
...
function step()
    ...
    if segments[1] ~= nil then
        if (segments[1].dist-segments[1].r-self.segment_radius) < 20 then
            turbo = true
        end
